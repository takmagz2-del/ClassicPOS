import { SaleItem } from "./sale"; // Reusing SaleItem structure for GRN/TOG items
import { Product } from "./product"; // For linking products
import { Store } from "./store"; // For linking stores
