...
import { Home, ShoppingCart, Users, LineChart, Settings, Boxes, Store, DollarSign, History, Truck, Package, FileText, SlidersHorizontal, Repeat, BookText } from "lucide-react"; // New import: BookText icon for Inventory History
