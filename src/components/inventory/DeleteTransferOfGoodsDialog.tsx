        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <p className="mt-2 text-yellow-600 dark:text-yellow-400">
              Note: Deleting a transfer will NOT automatically reverse any stock changes that have already occurred (e.g., if it was marked 'in-transit' or 'received'). Manual adjustment may be required.
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
