...
import CustomerDetail from "@/pages/CustomerDetail"; // New import
...
export const routesConfig = [
  ...
  { path: "/customers/:id", title: "Customer Details", component: CustomerDetail, requiredRoles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.EMPLOYEE] }, // New route
